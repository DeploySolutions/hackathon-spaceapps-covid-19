...
{
    public abstract class Covid19AdminWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static Covid19AdminWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(Covid19AdminWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<Covid19AdminDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<Covid19AdminDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<Covid19AdminDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<Covid19AdminDbContext, Task<T>> func)
        {
            T result;
