...
using DeploySolutions.Covid19Admin.Web.Models.Account;
using DeploySolutions.Covid19Admin.Web.Views.Shared.Components.TenantChange;

namespace DeploySolutions.Covid19Admin.Web.Controllers
{
    public class AccountController : Covid19AdminControllerBase
    {
