...
namespace DeploySolutions.Covid19Admin.Web.Startup
{
    ...
    /// </summary>
    public class Covid19AdminNavigationProvider : NavigationProvider
    {
        public override void SetNavigation(INavigationProviderContext context)
        {
            context.Manager.MainMenu
                ...
                .AddItem(
                    new MenuItemDefinition(
                        PageNames.CovidCases,
                        L("CovidCases"),
                        url: "",
                        icon: "fas fa-covidcases",
                        requiresAuthentication: true
                    )
                )
                .AddItem(
                    new MenuItemDefinition(
                        PageNames.EnvironmentFactors,
                        L("EnvironmentFactors"),
                        url: "",
                        icon: "fas fa-environmentfactors",
                        requiresAuthentication: true
                    )
                )
                .AddItem(
