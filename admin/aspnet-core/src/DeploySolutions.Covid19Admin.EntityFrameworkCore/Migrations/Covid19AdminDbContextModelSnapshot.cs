...
namespace DeploySolutions.Covid19Admin.Migrations
{
    ...
    partial class Covid19AdminDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DeploySolutions.Covid19Admin.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("DeploySolutions.Covid19Admin.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("DeploySolutions.Covid19Admin.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("DeploySolutions.Covid19Admin.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("DeploySolutions.Covid19Admin.Authorization.Roles.Role", b =>
                {
                    b.HasOne("DeploySolutions.Covid19Admin.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("DeploySolutions.Covid19Admin.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("DeploySolutions.Covid19Admin.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
